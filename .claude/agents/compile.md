---
name: compile
description: Compile code autonomously. Use proactively after writing or modifying code to verify it compiles. Detects project type (Scala/Kotlin/TypeScript/Ruby) and runs appropriate build tool.
