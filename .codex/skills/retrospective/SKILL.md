...
**Core principle:** A retrospective is worthless without a concrete change. Every useful finding produces either a proposed skill-file edit or a proposed durable note/memory entry. Anything else is venting.
...
| Codebase-specific tripwire | propose project memory or task-note update |
| How user likes to work | propose feedback memory |
| Project/team fact | propose project memory or task-note update |
